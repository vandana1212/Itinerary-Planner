...
public class touristcontrol extends HttpServlet {
	...
	private static String TOURIST_SIGNUP = "content/CreateNewaccount.jsp";
	...
	protected void doPost(HttpServletRequest request,
		...
		if (touristrepository != null) {
			if (pageName.equals("CreateNewaccount")) {
				...
				if (result == true) {
					request.getSession().setAttribute("loggedInUser", request.getParameter("username"));
